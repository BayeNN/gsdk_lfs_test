 ...
 * @{
 *
 * This enum defines the property flags for GATT characteristic values.
 */

/** A GATT client can read the characteristic value. */
#define SL_BT_GATTDB_CHARACTERISTIC_READ              0x1       

/** A GATT client can write the characteristic value. */
#define SL_BT_GATTDB_CHARACTERISTIC_WRITE             0x2       
...
#define SL_BT_GATTDB_CHARACTERISTIC_RELIABLE_WRITE    0x8       
 ...
 * The entry in bonding database can be either bonding or whitelisted device.
 * Use @ref sl_bt_sm_get_bonding_details to find the type of bonding entry and
 * the device's address.
 *
 * @param[in] reserved Use the value 0 on this reserved field. Do not use
 *   none-zero values because they are reserved for future use.
 * @param[out] num_bondings Total number of bondings and whitelisted devices
 *   stored in bonding database.
 ...
 *   to @p bondings
 * @param[out] bondings 4 byte bit field of used bonding handles. Bit 0 of first
 *   byte is bonding handle 0, bit 0 of second byte is bonding handle 8 etc. If
 *   the bit is 1 that bonding handle exists in the bonding database.
 *
 * @return SL_STATUS_OK if successful. Error code otherwise.
 *
 ******************************************************************************/
 ...
 *   security mode. Whitelist entry has security mode as no security. Values:
 ...
 *       key
 * @param[out] key_size Key length in bytes, 0 for whitelist entry
 *
 * @return SL_STATUS_OK if successful. Error code otherwise.
 *
 ******************************************************************************/
...
/***************************************************************************//**
 *
 * Find the bonding or whitelist entry by a Bluetooth device address.
 *
